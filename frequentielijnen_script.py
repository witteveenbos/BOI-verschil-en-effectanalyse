...
if __name__ == "__main__":
    ...
    zip_file_name = "HydraNL_BI2023_MRN_Markermeer_as.zip" # naam van het zip bestand waarin de data staat, b.v. "HydraNL_BI2023_BOR_Rijn_as.zip" of "HydraNL_BI2023_BOR_Meren.zip"
